namespace BlueBrown.Data.DataManagementPatterns.Shared
{
	public record Response
	{
		...
		public Response(bool isSuccess, int statusCode, string? errorMessage = default, ErrorCode? errorCode = default)
		{
			IsSuccess = isSuccess;
	...
	public record Response<TResult> : Response
	{
		...
		public Response(bool isSuccess, int statusCode, string? errorMessage = default, TResult? result = default, ErrorCode? errorCode = default)
